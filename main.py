...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("### \U0001f4ca Google Sheets (optional)")
    ...
    st.markdown("---")
    st.markdown("### \U0001f4e7 Email Notifications (optional)")
...
st.markdown(
    f'<div class="m2a-repo-link">\U0001f4e6 <a href="{GITHUB_REPO_URL}" target="_blank">{GITHUB_REPO_LABEL}</a></div>',
    unsafe_allow_html=True,
)
...
st.markdown('<div class="m2a-section-title">\U0001f4dd Meeting Transcript</div>', unsafe_allow_html=True)
...
analyze_clicked = st.button("\U0001f50d Analyze Meeting", type="primary", use_container_width=False)
...
if analysis:
    st.markdown('<div class="m2a-card">', unsafe_allow_html=True)
    st.markdown('<div class="m2a-section-title">\U0001f4cb Summary</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="m2a-card">', unsafe_allow_html=True)
    st.markdown('<div class="m2a-section-title">\U0001f5c2\ufe0f Action Items \u2014 Review & Edit</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="m2a-card">', unsafe_allow_html=True)
    st.markdown('<div class="m2a-section-title">\U0001f680 Approve & Execute</div>', unsafe_allow_html=True)
